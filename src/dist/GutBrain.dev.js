...
function () {
  ...
  _createClass(GutBrain, [{
    ...
    value: function preload() {
      this.brainImages = [loadImage("../assets/gutBrain/brainWhole.png"), loadImage("../assets/gutBrain/brainScan1.png"), loadImage("../assets/gutBrain/brainScanWhole.png")];
      ...
      this.vagusNerveImages = [loadImage("../assets/gutBrain/vagusNerve.png"), loadImage("../assets/gutBrain/vagusNerve1.png"), loadImage("../assets/gutBrain/vagusNerve2.png"), loadImage("../assets/gutBrain/vagusNerve3.jpeg"), loadImage("../assets/gutBrain/vagusNerve4.png"), loadImage("../assets/gutBrain/vagusNerve5.png")];
      this.allImages = [].concat(_toConsumableArray(this.brainImages), _toConsumableArray(this.gutImages), _toConsumableArray(this.flowerImages), _toConsumableArray(this.vagusNerveImages));
