class GutBrain {
  constructor() {
    this.text = [
      ...
      "The gut is in constant bidirectional communication with the brain. (2-6). One of the key players here is the vagus nerve. It consists of 80% afferent (going towards the brain), and 20% efferent nerves (from the brain to the gut). The stimulation of the afferent nerves influences systems in the brainstem that play crucial roles in major psychiatric conditions, such as mood and anxiety disorders. Interestingly, the beneficial effect on mood and anxiety by gut bacteria is found to be caused by affecting the activity of the vagus nerve. Additionally the activity in the vagus nerve is correlated with the capacity to regulate stress responses (8, 9).",
      ...
      "One way to reach awareness among people would be through education. Nowadays, people generally know that food intake influences their physical health. However, although research is showing evidence on the relation between food intake, gut microbiota and mental health, this has not reached the public yet. On the other hand, it is almost an universal human experience for stress or anxiety to alter the gut function and cause symptoms like diarrhoea, nausea and discomfort.",
