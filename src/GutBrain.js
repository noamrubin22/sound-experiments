class GutBrain {
  constructor(chapterManager) {
    this.text = [
      ...
      "For that reason, I was thinking of creating an application, where users’ could collect information about their mood, food intake and digestion with a daily questionariy. Optional would be to use image recognition and in this way categorize “happy”, “depressed” and “anxious” feces.",
  ...
  draw() {
    ...
    if (this.index < 3) {
      ...
      if (this.index === 1) {
        image(this.brainImages[0], windowWidth / 2, this.posY + this.posYPlus);
      ...
      push();
      tint(255, 200);
      image(this.vagusNerveImages[3], 200, this.posYPlus + 50, 600, 400);
      pop();
      textSize(15);
      text("(Breit & Kupferberg et al., 2018)", 250, windowHeight - 80);
