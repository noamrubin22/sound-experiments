class GutBrain {
  constructor(chapterManager) {
    this.text = [
      ...
      "For that reason, I was thinking of creating an application, where users’ could collect information about their mood, food intake and digestion with a daily questionary. Optional would be to use image recognition and in this way categorize “happy”, “depressed” and “anxious” feces.",
