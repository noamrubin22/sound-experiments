class Depressed {
  constructor() {
    ...
    this.text = [
      ...
      "each year, 1 in 5 adults is experiencing mental illness (5)",
      "33% of patients are resistant against treatment(7)",
      "66% of patients remain symptomatic (6)",
      "30% of patients do not respond to any treatment at all",
      "for 70 years the efficiency of treatment for mental health has not been approved",
